...
def default_hparams():
  ...
  return tf.contrib.training.HParams(
      ...
      train_adv_method='clean',  # adversarial training method: {clean, pgdll , pgdrnd, pgd}
      ...
      learning_rate=0.010,##0.045
      lr_decay_factor=0.8,  # Learning exponential decay 0.94
      lr_num_epochs_per_decay=0.2,  # Number of epochs per lr decay ### 2.0
